...
const dev = gulp.series(clean, pngSprite, gulp.parallel(pug, styles, scripts, img, temp, fonts, svg), copy, browsersync, watcher);
const build = gulp.series(clean, pngSprite, gulp.parallel(pug, styles, scripts, img, temp, fonts, svg), copy);
